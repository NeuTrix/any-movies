require 'test_helper'
  ...
  test "should create favourite" do
    ...
    assert_difference('Favourite.count') do
      post api_favourites_url, params: { favourite: { favourited_id: @favourite.favourited_id, favourited_type: @favourite.favourited_type, user_id: @favourite.user_id } }, as: :json
    end
